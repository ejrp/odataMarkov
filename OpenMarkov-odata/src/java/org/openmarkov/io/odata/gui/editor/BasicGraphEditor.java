...
public class BasicGraphEditor extends JPanel
{
	...
	{
		JDialog frame = (JDialog) SwingUtilities.windowForComponent(this);
	 ...
	 * 
	 */
	public JDialog createFrame(JMenuBar menuBar, Frame aParent)
	{
		JDialog frame = new JDialog(aParent);
