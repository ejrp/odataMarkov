...
import org.openmarkov.io.odata.gui.editor.EditorActions.AlignCellsAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.AutosizeAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.BackgroundAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.BackgroundImageAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.ColorAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.ExitAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.GridColorAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.GridStyleAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.HistoryAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.ImportAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.KeyValueAction;
...
import org.openmarkov.io.odata.gui.editor.EditorActions.PageBackgroundAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.PageSetupAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.PrintAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.PromptPropertyAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.PromptValueAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.SaveAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.ScaleAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.SelectShortestPathAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.SelectSpanningTreeAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.SetLabelPositionAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.SetStyleAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.StyleAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.StylesheetAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.ToggleAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.ToggleConnectModeAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.ToggleCreateTargetItem;
import org.openmarkov.io.odata.gui.editor.EditorActions.ToggleDirtyAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.ToggleGridItem;
import org.openmarkov.io.odata.gui.editor.EditorActions.ToggleOutlineItem;
import org.openmarkov.io.odata.gui.editor.EditorActions.TogglePropertyItem;
import org.openmarkov.io.odata.gui.editor.EditorActions.ToggleRulersItem;
import org.openmarkov.io.odata.gui.editor.EditorActions.WarningAction;
import org.openmarkov.io.odata.gui.editor.EditorActions.ZoomPolicyAction;
...
public class EditorMenuBar extends JMenuBar
{
	...
	public EditorMenuBar(final BasicGraphEditor  editor)
	{
		...
		menu.add(editor.bind(mxResources.get("new"), new NewAction(), "/org/openmarkov/io/odata/gui/editor/images/new.gif"));
		menu.add(editor.bind(mxResources.get("openFile"), new OpenAction(), "/org/openmarkov/io/odata/gui/editor/images/open.gif"));
		menu.add(editor.bind(mxResources.get("importStencil"), new ImportAction(), "/org/openmarkov/io/odata/gui/editor/images/open.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("save"), new SaveAction(false), "/org/openmarkov/io/odata/gui/editor/images/save.gif"));
		menu.add(editor.bind(mxResources.get("saveAs"), new SaveAction(true), "/org/openmarkov/io/odata/gui/editor/images/saveas.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("pageSetup"), new PageSetupAction(), "/org/openmarkov/io/odata/gui/editor/images/pagesetup.gif"));
		menu.add(editor.bind(mxResources.get("print"), new PrintAction(), "/org/openmarkov/io/odata/gui/editor/images/print.gif"));
		...
		menu.add(editor.bind(mxResources.get("undo"), new HistoryAction(true), "/org/openmarkov/io/odata/gui/editor/images/undo.gif"));
		menu.add(editor.bind(mxResources.get("redo"), new HistoryAction(false), "/org/openmarkov/io/odata/gui/editor/images/redo.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("cut"), TransferHandler.getCutAction(), "/org/openmarkov/io/odata/gui/editor/images/cut.gif"));
		menu.add(editor.bind(mxResources.get("copy"), TransferHandler.getCopyAction(), "/org/openmarkov/io/odata/gui/editor/images/copy.gif"));
		menu.add(editor.bind(mxResources.get("paste"), TransferHandler.getPasteAction(), "/org/openmarkov/io/odata/gui/editor/images/paste.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("delete"), mxGraphActions.getDeleteAction(), "/org/openmarkov/io/odata/gui/editor/images/delete.gif"));
	...
	{
		menu.add(editor.bind(mxResources.get("home"), mxGraphActions.getHomeAction(), "/org/openmarkov/io/odata/gui/editor/images/house.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("exitGroup"), mxGraphActions.getExitGroupAction(), "/org/openmarkov/io/odata/gui/editor/images/up.gif"));
		menu.add(editor.bind(mxResources.get("enterGroup"), mxGraphActions.getEnterGroupAction(),
				"/org/openmarkov/io/odata/gui/editor/images/down.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("group"), mxGraphActions.getGroupAction(), "/org/openmarkov/io/odata/gui/editor/images/group.gif"));
		menu.add(editor.bind(mxResources.get("ungroup"), mxGraphActions.getUngroupAction(),
				"/org/openmarkov/io/odata/gui/editor/images/ungroup.gif"));
		...
		menu.add(editor.bind(mxResources.get("collapse"), mxGraphActions.getCollapseAction(),
				"/org/openmarkov/io/odata/gui/editor/images/collapse.gif"));
		menu.add(editor.bind(mxResources.get("expand"), mxGraphActions.getExpandAction(), "/org/openmarkov/io/odata/gui/editor/images/expand.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("toBack"), mxGraphActions.getToBackAction(), "/org/openmarkov/io/odata/gui/editor/images/toback.gif"));
		menu.add(editor.bind(mxResources.get("toFront"), mxGraphActions.getToFrontAction(),
				"/org/openmarkov/io/odata/gui/editor/images/tofront.gif"));
	...
	public static void populateFormatMenu(JMenu menu, BasicGraphEditor editor)
	{
		...
		submenu.add(editor.bind(mxResources.get("fillcolor"), new ColorAction("Fillcolor", mxConstants.STYLE_FILLCOLOR),
				"/org/openmarkov/io/odata/gui/editor/images/fillcolor.gif"));
		...
		submenu.add(editor.bind(mxResources.get("fontcolor"), new ColorAction("Fontcolor", mxConstants.STYLE_FONTCOLOR),
				"/org/openmarkov/io/odata/gui/editor/images/fontcolor.gif"));
		...
		submenu.add(editor.bind(mxResources.get("linecolor"), new ColorAction("Linecolor", mxConstants.STYLE_STROKECOLOR),
				"/org/openmarkov/io/odata/gui/editor/images/linecolor.gif"));
		...
		submenu.add(editor.bind(mxResources.get("straight"), new SetStyleAction("straight"),
				"/org/openmarkov/io/odata/gui/editor/images/straight.gif"));

		submenu.add(editor.bind(mxResources.get("horizontal"), new SetStyleAction(""), "/org/openmarkov/io/odata/gui/editor/images/connect.gif"));
		submenu.add(editor.bind(mxResources.get("vertical"), new SetStyleAction("vertical"),
				"/org/openmarkov/io/odata/gui/editor/images/vertical.gif"));

		submenu.addSeparator();

		submenu.add(editor.bind(mxResources.get("entityRelation"), new SetStyleAction("edgeStyle=mxEdgeStyle.EntityRelation"),
				"/org/openmarkov/io/odata/gui/editor/images/entity.gif"));
		submenu.add(editor.bind(mxResources.get("arrow"), new SetStyleAction("arrow"), "/org/openmarkov/io/odata/gui/editor/images/arrow.gif"));
		...
		submenu.add(editor.bind(mxResources.get("open"), new KeyValueAction(mxConstants.STYLE_STARTARROW, mxConstants.ARROW_OPEN),
				"/org/openmarkov/io/odata/gui/editor/images/open_start.gif"));
		...
		submenu.add(editor.bind(mxResources.get("diamond"), new KeyValueAction(mxConstants.STYLE_STARTARROW, mxConstants.ARROW_DIAMOND),
				"/org/openmarkov/io/odata/gui/editor/images/diamond_start.gif"));
		submenu.add(editor.bind(mxResources.get("oval"), new KeyValueAction(mxConstants.STYLE_STARTARROW, mxConstants.ARROW_OVAL),
				"/org/openmarkov/io/odata/gui/editor/images/oval_start.gif"));
		...
		submenu.add(editor.bind(mxResources.get("middle"), new KeyValueAction(mxConstants.STYLE_VERTICAL_ALIGN, mxConstants.ALIGN_MIDDLE),
				"/org/openmarkov/io/odata/gui/editor/images/middle.gif"));
		submenu.add(editor.bind(mxResources.get("bottom"), new KeyValueAction(mxConstants.STYLE_VERTICAL_ALIGN, mxConstants.ALIGN_BOTTOM),
				"/org/openmarkov/io/odata/gui/editor/images/bottom.gif"));
