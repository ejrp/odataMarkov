...
import org.openmarkov.io.odata.SchemaDataBaseReader;
import org.openmarkov.io.odata.gui.OdataExplorerCanvas;
import org.openmarkov.learning.core.LearningManager;
import org.openmarkov.learning.core.LearningManager.ImportSupportedTypes;
...
public class LearningDialog extends javax.swing.JDialog {
    ...
    private ImportSupportedTypes importType;
    ...
    public LearningDialog(JFrame parent) {
        ...
        dataStatisticsPanel.setLayout(new GridLayout(0,1,0,20));
...
//                            getCurrentNetworkPanel() != null);
    ...
    private void initComponents() {
        ...
        dataStatisticsPanel = new javax.swing.JPanel();
        ...
        loadModeComboBox = new javax.swing.JComboBox<String>();
        ...
        loadCaseFileButton.setEnabled(false);
    ...
    loadModeComboBox.setModel(new javax.swing.DefaultComboBoxModel(LearningManager.getImportingOptions().toArray ()));
    loadModeComboBox.addActionListener(new java.awt.event.ActionListener() {
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            loadModelComboBoxActionPerformed(evt);
        }
    });
    ...
    jPanel1Layout.setHorizontalGroup(
        ...
        .add(jPanel1Layout.createSequentialGroup()
        	...
        	.add(loadModeComboBox,org.jdesktop.layout.GroupLayout.PREFERRED_SIZE,400,org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
            .addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
    );
    ...
    org.jdesktop.layout.GroupLayout dataStatisticsPanelLayout = new org.jdesktop.layout.GroupLayout(dataStatisticsPanel);
    dataStatisticsPanel.setLayout(dataStatisticsPanelLayout);
    dataStatisticsPanelLayout.setHorizontalGroup(
    		dataStatisticsPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        .add(0, 150, Short.MAX_VALUE)
    );
    dataStatisticsPanelLayout.setVerticalGroup(
    		dataStatisticsPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        .add(0, 232, Short.MAX_VALUE)
    );
    gridBagConstraints = new java.awt.GridBagConstraints();
    ...
    showVariablesPanel.add(dataStatisticsPanel, gridBagConstraints);
    ...
    variablesPanelLayout.setHorizontalGroup(
        ...
        .add(variablesPanelLayout.createSequentialGroup()
            .add(variablesPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                ...
                .add(variablesPanelLayout.createSequentialGroup()
                    .add(jScrollPane4, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 900, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(0, 0, Short.MAX_VALUE)))
            .addContainerGap())
    );
    ...
    progressBarFrame.setContentPane(panel);
 ...
 case FILE_IMPORT:
        ...
        break;
 case ODATA_IMPORT:
 	GraphElementsSelector elementSelector;
    OdataExplorerCanvas explorer = new OdataExplorerCanvas();
    elementSelector = explorer.accessOdataBase(this, new WindowListener() {
		...
		public void windowClosed(WindowEvent e) {
			if (explorer.getElementSelector() != null) {
				loadCaseOdata(explorer.getElementSelector());
			}
		}
    ...
    private void loadCaseFile (String path)
    {
        if ((path != null) && (!path.equals ("")))
        {
            ...
            loadCase(reader);
            propName = databasePath.substring(databasePath.lastIndexOf('\\') + 1,
    ...
    private void loadCaseOdata (GraphElementsSelector elementSelector)
    {
//        if ((path != null) && (!path.equals ("")))
//        {
       //     CaseDatabaseReader reader = caseDbManager.getReader (FilenameUtils.getExtension (path));
           
            CaseDatabaseReader reader = new SchemaDataBaseReader(elementSelector);
            databasePath = elementSelector.getSelectedTables().iterator().next().toString();
            databaseName = StringUtils.join( elementSelector.getSelectedElements().getAllVertex().values().iterator().next(), ",");
                   ...
                   if (databasePath != null)
                    {
                    	...
                    	propName = databasePath + stringDatabase.getString("Learning.NetSuffix"); 
                    }
                }
...
//    }
	...
	private void loadCase(CaseDatabaseReader reader) {
		if (reader == null)
		{
			JOptionPane.showMessageDialog (null,
					stringDatabase.getString ("Learning.IncorrectCaseDatabaseFileFormat"),
    ...
    {// GEN-FIRST:event_learnButtonActionPerformed
        ...
        try
        {
        	...
        	progressBar.setValue(0);
        	taskOutput.append("Starting Pre-processing");
    ...
    private void loadModelComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_algorithmComboBoxActionPerformed
    	String selectedImportType = (String) loadModeComboBox.getSelectedItem();
    	importType = LearningManager.getImportingOptionByName(selectedImportType);
    	loadCaseFileButton.setEnabled (importType != null);
    }//GEN-LAST:event_algorithmComboBoxActionPerformed
    ...
    private void updateVariableSelectionPanel(){
        ...
        if(database != null)
        {
            ...
            for(Variable var : database.getVariables()){
                ...
                DoubleSummaryStatistics statisticsVal = new DoubleSummaryStatistics();
				isNumeric[i] = Discretization.isNumeric (var,statisticsVal);
				String statisticsValues = "NaN";
				if (statisticsVal.getCount() > 0) {
					statisticsValues  = String.format("Max:%.2f, Min:%.2f, Avg:%.2f, Cnt:%d",statisticsVal.getMax(),statisticsVal.getMin(), statisticsVal.getAverage(),statisticsVal.getCount());  
				}else {
					if (var.getNumStates() > 0)
						statisticsValues = "NaN-> ex.".concat(var.getStates()[0].toString());
					else
						statisticsValues = "EMPTY(no records retrived)";
				}
				JLabel numericStatistics = new JLabel(statisticsValues);
               ...
               numIntervals.setEnabled(isNumeric[i] && discretizeOptions.getSelectedIndex () > 1);
                ...
                dataStatisticsPanel.add(numericStatistics);
            ...
            dataStatisticsPanel.revalidate();
        }
    }
    ...
    private javax.swing.JComboBox<String> loadModeComboBox;
    ...
    private static javax.swing.JPanel dataStatisticsPanel;    
