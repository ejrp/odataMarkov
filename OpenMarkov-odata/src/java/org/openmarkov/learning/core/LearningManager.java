...
public class LearningManager {
    ...
    public enum ImportSupportedTypes {
		ODATA_IMPORT,
		FILE_IMPORT
	}
        ...
        EmptyModelNetException, LatentVariablesException
    {
        ...
        if (modelNetUse != null ) {
        	if (modelNetUse.isUseModelNet ())
        	{
        		...
        		if (modelNet.getNetworkType() instanceof MarkovNetworkType) {
                    this.learnedNet = modelNet;
    ...
    public static Set<String> getImportingOptions ()
    {
        Set <String> options = new TreeSet<String>();
        for (ImportSupportedTypes value :ImportSupportedTypes.values()){
        	options.add(value.toString());
        }
		return options;
    } 
    public static ImportSupportedTypes getImportingOptionByName (String anOption)
    {      
		return ImportSupportedTypes.valueOf(anOption);
    } 
